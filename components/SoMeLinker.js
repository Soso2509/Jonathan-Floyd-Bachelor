  ...
  return (
    <div className="someLinker">
      <a
        ...
        target="_blank"
      >
        <Image src={instagram} className="SoMeIcon" alt="Instagram Icon/link" />
      </a>

      <a href="https://www.facebook.com/jonathanfloydofficial/" target="_blank">
        <Image src={facebook} className="SoMeIcon" alt="Facebook Icon/link" />
      </a>

      <a href="https://www.tiktok.com/@jonathanfloydofficial" target="_blank">
        <Image src={tiktok} className="SoMeIcon" alt="Tiktok Icon/link" />
      </a>
      <a href="https://www.youtube.com/@jonathanfloydofficial" target="_blank">
        <Image src={youtube} className="SoMeIcon" alt="YouTube Icon/link" />
      </a>
      ...
      <a
        ...
        target="_blank"
      >
        <Image src={spotify} className="SoMeIcon" alt="Spotify Icon/link" />
      </a>
      ...
      <a
        ...
        target="_blank"
      >
        <Image src={itunes} className="SoMeIcon" alt="iTunes Icon/link" />
      </a>
    </div>
  );
}
