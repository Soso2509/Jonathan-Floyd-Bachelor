...
export default function SoMeLinker() {
  return (
    <div className="someLinker">
      <a href="https://www.instagram.com/jonathanfloydofficial/">
        <Image
          src={instagram}
          className="SoMeIcon"
      ...
      <a href="https://www.facebook.com/jonathanfloydofficial/">
        <Image
          src={facebook}
          className="SoMeIcon"
      ...
      <a href="https://www.tiktok.com/@jonathanfloydofficial">
        <Image
          src={tiktok}
          className="SoMeIcon"
          alt="Tiktok Icon/link"/>
      </a>
      <a href="https://www.youtube.com/@jonathanfloydofficial">
        <Image
          src={youtube}
          className="SoMeIcon"
      ...
      <a href="https://open.spotify.com/artist/11kCkdHKt7MYt0nkyj8XjP?si=f0t8OQfLRm-dfvq5pvVvcA&nd=1&dlsi=fc2bb008f29c4284">
        <Image
          src={spotify}
          className="SoMeIcon"
